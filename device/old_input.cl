...
*/
__kernel
void kernel_init_ht(__global char * restrict ht, 
...
*/
uint ht_store(uint round, __global char * restrict ht, uint i,
...
** Return 0 if successfully stored, or 1 if the row overflowed.
*/
uint xor_and_store(uint round, __global char * restrict ht_dst, uint row,
        uint slot_a, uint slot_b, __global ulong * restrict a, 
        __global ulong * restrict b, __global uint * restrict rowCounters)
{
    ulong xi0, xi1, xi2;
...
void equihash_round(uint round,
        __global char * restrict ht_src,
        __global char * restrict ht_dst,
        __global uint * restrict debug,
        __local uchar * restrict first_words_data,
        __local uint  * restrict collisionsData,
        __local uint  * restrict collisionsNum,
    ...
    for (uint index = tlid; index < totalCollisions; index += get_local_size(0))
      {
        ...
        __global uchar *ptr = (__global uchar *)(ht_src + collisionThreadId * NR_SLOTS * SLOT_LEN + xi_offset);
...
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) \
void kernel_round ## N(__global char * restrict ht_src, \
        __global char * restrict ht_dst, \
        __global uint * restrict rowCountersSrc, \
        __global uint * restrict rowCountersDst, \
        __global uint * restrict debug) \
...
__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void kernel_round8(__global char * restrict ht_src, 
        __global char * restrict ht_dst,
        __global uint * restrict rowCountersSrc, 
        __global uint * restrict rowCountersDst,
        __global uint * restrict debug, 
...
*/
uint expand_refs(uint * restrict ins, uint nr_inputs, 
        __global char ** restrict htabs, uint round)
{
...
*/
void potential_sol(__global char ** restrict htabs, 
        __global sols_t * restrict sols, uint ref0, uint ref1)
{
    uint    nr_values;
...
*/
__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void kernel_sols(__global char * restrict ht0, 
        __global char * restrict ht1, 
        __global sols_t * restrict sols,
        __global uint * restrict rowCountersSrc, 
        __global uint * restrict rowCountersDst)
{
